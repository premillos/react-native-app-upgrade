...
public class DownloadService extends IntentService {
    ...
    protected void onHandleIntent(final Intent intent) {
        ...
        try {
            ...
            String apkName = getRandomFileName();
            ...
            if (getFileMD5(apkFile) != intent.getStringExtra(Constants.APK_HASH)) {
                Log.i("pssgo", "下载文件md5和远程md5不一致");
            }
            installAPk(apkFile);
            mNotifyManager.cancel(NOTIFICATION_ID);
    ...
    public static String getRandomFileName() {
        ...
        for (int i = 0; i< 10;i++) {
            int n = rd.nextInt(base.length());
            sb.append(base.charAt(n));
        }
        return sb.toString() + st + ".apk";
    }
